...
class BookingServiceUnitTest {
    ...
    void getBookingsByUserByState_whenValid_thenReturnBookingsList() {
        ...
        Booking booking1 = BookingMapper.toBooking(request1, booker, item);
        long bookingId1 = 1L;
        ...
        Booking booking2 = BookingMapper.toBooking(request2, booker, item);
        long bookingId2 = 2L;
        ...
        Booking booking3 = BookingMapper.toBooking(request3, booker, item);
        long bookingId3 = 3L;
        ...
        when(bookingRepository.findAllByBookerIdFuture(bookerId, page))
                .thenReturn(Collections.emptyList());
        when(bookingRepository.findAllByBookerIdAndStatusOrderByStartDesc(bookerId, BookingStatus.REJECTED, page))
    ...
    void getOwnerItemsBooked_whenValid_thenReturnBookingsList() {
        ...
        when(bookingRepository.findAllByItemOwnerIdFutureOrderByStartDesc(ownerId, page))
                .thenReturn(Collections.emptyList());
        when(bookingRepository.findAllByItemOwnerIdAndStatusOrderByStartDesc(ownerId, BookingStatus.REJECTED, page))
                .thenReturn(List.of(booking3));
