...
class ItemDataJpaTest {
    ...
    public void shouldSearchForItems() {
        ...
        Item item1 = ItemMapper.toItem(ItemDto.builder().name("Item1").description("Description1").available(true).build());
        Item item2 = ItemMapper.toItem(ItemDto.builder().name("Item2").description("Description2").available(true).build());
