...
class ItemRequestServiceUnitTest {
    ...
    void createNewItemRequest_whenValid_thenReturnRequest() {
        ...
        ItemRequestDtoWithoutItems expected = ItemRequestMapper.toItemRequestDto(itemRequest);
        ItemRequestDtoWithoutItems actual = itemRequestService.createNewItemRequest(userId, itemRequestDescription);
    ...
    void getOtherUsersItemRequests_whenValid_thenReturnItemRequestWithItems() {
        ...
        List<ItemRequestDtoWithItems> actual = itemRequestService.getOtherUsersItemRequests(userId, from, size);
        assertEquals(expected, actual);
    }
    ...
    void getItemRequestById_whenValid_thenReturnItemRequest() {
        ...
        ItemRequestDtoWithItems expected = ItemRequestMapper.toItemRequestWithItemsDto(itemRequest);
        expected.setItems(Collections.emptyList());
        ItemRequestDtoWithItems actual = itemRequestService.getItemRequestById(userId, itemRequestId);
        assertEquals(expected, actual);
    }
